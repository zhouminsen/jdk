...
public class XmlToData2 {
    ...
    public void xml() throws DocumentException {
        ...
        sources.add(new IfmPlatformTemplateDetailDTO(9, 8, "id", 1, "t2", "id", 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(10, 9, 3, "foreign_id", 3, "t2", "order_id", 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(11, 9, "outBizCode", 9, "t2", "outBizCode", 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(12, 9, "remark", 9, "t2", "remark", 0, 1));

        sources.add(new IfmPlatformTemplateDetailDTO(13, 9, "snList", 0, 0, 2));
        sources.add(new IfmPlatformTemplateDetailDTO(14, 13, "id", 1, "t3", "id", 0, 2));
        sources.add(new IfmPlatformTemplateDetailDTO(15, 14, "foreign_id", 2, "t3", "sub_id", "id", 0, 2));
        sources.add(new IfmPlatformTemplateDetailDTO(16, 14, "sn", 9, "t3", "sn2", 0, 2));

        sources.add(new IfmPlatformTemplateDetailDTO(17, 9, "batchs", 0, 0, 0));
        sources.add(new IfmPlatformTemplateDetailDTO(18, 17, "batch", 0, 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(19, 18, "id", 1, "t4", "id", 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(20, 19, "foreign_id", 2, "t4", "order_id", "id", 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(21, 19, "batchCode", 9, "t4", "batchCode", 0, 1));
//            sources.add(new IfmPlatformTemplateDetailDTO9102, 13, "productDate", 9, "t4", "batchCode2", 0));
        sources.add(new IfmPlatformTemplateDetailDTO(22, 19, "productDate", 9, "t4", "productDate_text", 1, 0, "0", "2", 1));
        sources.add(new IfmPlatformTemplateDetailDTO(23, 19, "productDate", 9, "t4", "productDate_text2", 1, 0, "2", "4", 1));
//
//        //并集无外键
...
//
        ...
        sources.add(new IfmPlatformTemplateDetailDTO(29, 28, "id", 1, "t7", "id", 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(30, 29, "foreign_id", 2, "t7", "order_id", "id", 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(31, 29, "inventoryType", 9, "t7", "confirmType", 0, 1));
//
//        并集无外键
        sources.add(new IfmPlatformTemplateDetailDTO(32, 7, "orderLine", 0, 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(33, 32, "id", 1, "t8", "id", 0, 1));
        sources.add(new IfmPlatformTemplateDetailDTO(34, 33, "produceCode", 9, "t8", "produceCode", 0, 1));
