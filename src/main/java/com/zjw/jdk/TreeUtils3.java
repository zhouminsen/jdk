...
public class TreeUtils3 {
    ...
    private static void test2() throws DocumentException, InvocationTargetException, IllegalAccessException {
        ...
        sources.add(new Dic(8, 6, "remark", 9, "t2", "remark"));
        ...
        sources.add(new Dic(16, 13, "productDate", 9, "t4", "productDate"));

        sources.add(new Dic(17, 1, "entryOrder", 1, "t5", "id"));
        sources.add(new Dic(18, 17, "confirmType", 9, "t5", "confirmType"));
        sources.add(new Dic(19, 17, "status", 9, "t5", "status"));

        sources.add(new Dic(20, 12, "batch", 1, "t7", "id"));
        sources.add(new Dic(21, 20, "batch", 2, "t7", "order_id", "id"));
        sources.add(new Dic(22, 20, "inventoryType", 9, "t7", "confirmType"));

        sources.add(new Dic(23, 5, "orderLine", 1, "t8", "id"));
        sources.add(new Dic(25, 23, "produceCode", 9, "t8", "produceCode"));
        ...
        NT nt = nts.get(0);
//        System.out.println(JSON.toJSONString(nt));
